    ...
    <div class="container">
        <div class="row">
	        <div class="col-md-7 col-md-offset-1 ">
	        	<p><center><h4><?php echo ($pic['ptitle']); ?></h4></center></p>
	            <?php echo ($pic['pcontent']); ?>

                 <center><a href="<?php echo U('Home/Lab/picnewspre',array('id'=>$pic['id']));?>" class="button button-border button-rounded button-primary button-tiny">Prev</a>
                 <a href="<?php echo U('Home/Lab/listpicnews');?>" class="button  button-border button-rounded button-primary button-tiny">More</a>
                 <a href="<?php echo U('Home/Lab/picnewsnext',array('id'=>$pic['id']));?>" class="button  button-border button-rounded button-primary button-tiny">Next</a></center>    
            </div>
              <div class="col-md-3">
              <div class="row">
                  <div class="col-md-12">
